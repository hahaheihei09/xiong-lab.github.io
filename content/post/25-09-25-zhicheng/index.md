...
This research combines **Discrete Element Method (DEM)** and **Finite Element (FE) simulation** to create a detailed model predicting bruise damage during robotic handling. The work provides crucial data for designing gentler robotic grippers to minimize fruit loss.
