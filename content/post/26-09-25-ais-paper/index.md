...
The study proposes an occlusion-aware six-degree-of-freedom harvesting-pose selection method combined with adaptive obstacle clearing. Candidate end-effector poses are evaluated using a ripeness-weighted obstruction-risk score, while RRT-Connect verifies reachability and collision feasibility. When no collision-free approach is available, the system adaptively clears obstacles according to the local environment and fruit ripeness.
